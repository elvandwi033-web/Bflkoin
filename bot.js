...
client.on('messageCreate', async (message) => {
  ...
  if (command === 'help') {
    ...
    const embed1 = new EmbedBuilder()
      ...
      .addFields(
        ...
        { name: '🏹 BERBURU MONSTER', value: '`!hunt` - 800 BFL | WR 60% | 7 monster (1.000-20.000 BFL)\n`!jual monster` untuk jual hasil buruan' },
    ...
    const embed2 = new EmbedBuilder()
      ...
      .addFields(
        ...
        { name: '🔫 SENJATA (Badside Only)', value: '`!senjata` - Lihat daftar & harga\n`!senjata p50/vector/uzi/m416/ak47/kar98k` - Beli\n⚠️ Goodside & Netral **TIDAK BISA** beli senjata!' },
  ...
  if (command === 'hunt') {
    ...
    const HUNT_COST = 800;
    const HUNT_WR   = 0.60; // 60% win rate
      ...
      return message.reply({ embeds: [
        new EmbedBuilder()
          ...
          .addFields(
            ...
            { name: '🎯 Win Rate', value: '60%', inline: true },
            { name: '❤️ Sisa Nyawa', value: hungerBar(user.hunger), inline: false }
          )
    ...
    return message.reply({ embeds: [
      new EmbedBuilder()
        ...
        .setColor(C_GREEN)
        .setDescription('Kamu berhasil memburu **' + monster.name + '** ' + monster.emoji + '!')
        .addFields(
        ...
        .setFooter({ text: 'Biaya berburu: 800 BFL | WR: 60% | 7 jenis monster tersedia' })
    ]});
  }
