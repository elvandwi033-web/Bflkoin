  ...
  if (command === 'help') {
    ...
    const embed1 = new EmbedBuilder()
      ...
      .addFields(
        ...
        { name: '💸 CASHBACK HARIAN', value: '`!cashback` — 30% dari total kekalahan hari ini' },
        ...
        { name: '👑 VIP DEWA KERA', value: '`!beli vip` - 1.000.000 BFL | WR +10% | Pajak 5% | 20 menit' },
    ...
    const embed2 = new EmbedBuilder()
      ...
      .addFields(
        ...
        { name: '🔫 SENJATA (Badside)', value: '`!senjata` - Lihat daftar & harga\n`!senjata p50/vector/uzi/m416/ak47/kar98k` - Beli senjata' },
        { name: '⚔️ PERANG', value: '`!war @user` - Tantang perang (2 menit, 5 ronde)\n`!warleaderboard` - Top kill\nPemenang dapat 20% saldo + senjata lawan!' },
        ...
        { name: '🌿 NARKOBA (Badside)', value: '`!tokodrug` - Toko bibit\n`!belibibit weed/meth <jml>` - Beli & tanam (10 menit tumbuh)\n`!cektanaman` - Status tanaman\n`!panen` - Panen hasil\n`!jualdrug weed/meth <jml>` - Jual (WR 65%)\n`!druginv` - Lihat inventory' },
        { name: '🚔 PENGEJARAN (Polisi/Tentara)', value: '`!pengejaran @user` - Tangkap penjual narkoba (WR 50:50)\n✅ Berhasil = dipenjara 10 menit + narkoba disita' },
